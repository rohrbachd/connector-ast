...
3. **Module boundaries**: collapse plugin surface to three interfaces (Adapter, DutyExecutor, Verifier). Remove any requirement for separate SPI packages per concern in our MVP.
